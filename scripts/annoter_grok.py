# -*- coding: utf-8 -*-
"""Annotation du corpus lexical par Grok (API xAI). La consigne, la lecture du corpus
et l'analyse des réponses viennent de annoter_gemini.py : consigne identique.
"""
...
from annoter_gemini import PROMPT, FICHIER_SOURCE, charger_tweets, parser_reponse
...
FICHIER_SORTIE = SOURCES / f"annotations_grok_lexical_passe{PASSE}.xlsx"
FICHIER_JOURNAL = SOURCES / f"journal_grok_lexical_passe{PASSE}.json"
